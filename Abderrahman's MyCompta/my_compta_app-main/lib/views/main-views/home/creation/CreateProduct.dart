...
class _CreateProductState extends State<CreateProduct> {
                        ...
                        children: [
                          Expanded(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value.isEmpty) {
                                  return 'Le nombre des pieces produit est obligatoire';
                                }
                                if (double.tryParse(value) == null)
                                  return 'Le nombre des pieces n\'est pas valide';
                                return null;
                              },
                              decoration: InputDecoration(
                                labelText: 'Quantitée ',
                    ...
                    Container(
                      margin: EdgeInsets.symmetric(
                       ...
                       child: TextFormField(
                              validator: (value) {
                                if (value.isEmpty) {
                                  return 'Le prix du ve est obligatoire';
                                }
                                if (double.tryParse(value) == null)
                                  return 'Le prix n\'est pas valide';
                                return null;
  ...
  submitForm() async {
    ...
    // int vent =int.parse(_venteController.text);
    // double achat =  double.tryParse(_priceController.text);
        ...
        Product p = new Product(
            ...
            createdAt: DateTime.now(),
            vente: int.parse(_venteController.text),
            price:double.tryParse(_priceController.text),
            nbPieces: int.parse(_nbController.text),
      );
